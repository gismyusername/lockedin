...
cd "$(dirname "$0")/.."
OUT=$(mktemp -d)
swiftc -O Sources/LockedIn/LocalStore.swift Sources/LockedIn/MonthGrid.swift Sources/LockedIn/BoardRange.swift Tests/LocalStoreTests/main.swift -o "$OUT/storetest"
"$OUT/storetest"
